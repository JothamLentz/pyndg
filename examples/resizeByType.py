...
if __name__ == "__main__":
    ...
    object_types = ndg.page[pages[p]].objects['Type'].unique()
    o_type = easygui.choicebox(msg='Select which type of object to resize', title='Object Type', choices=object_types)
    ...
    x_size = float(x_text)
    y_size = float(y_text)
    object_nums = ndg.page[pages[p]].get_objects_by_type(o_type)
